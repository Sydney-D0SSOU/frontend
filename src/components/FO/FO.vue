<template>
    <div  id="page">
        <Nav id="nav"/>
        <div id="dash-name">Dashboard FRONT OFFICE</div>
        <input type="search" id="recherche"   class="form-control" placeholder="Recherche">
        ...
        <div id="box-versement" style="display: flex; flex-direction: column; background-color: white; position: absolute; top: 130px; left: 970px; height: 300px; width: 500px; padding-bottom: 10px; border-radius: 20px; overflow: auto">
            ...
            <div id="versement" v-for="(personne, k) in versements" :key="k" style="position: relative; margin-bottom: 30px; color: black; top: 80px; height: 50px; width: 400px; background-color: transparent;">
                ...
                <div v-if="personne.paye" style="position: relative; top: 25px; left: 100px">{{personne.prix}} fcfa
               </div>
                <div class="carre form-check form-switch" style="position: absolute; top: 5px; left: 50px" >
        ...
        <div id="box-licences" style="display: flex; flex-direction: column; background-color: white; position: absolute; top: 530px; left: 370px; height: 300px; width: 500px; padding-bottom: 10px; border-radius: 20px;">
            ...
            <div id="licences" v-for="(licence, k) in licences" :key="k" style="position: relative; margin-bottom: 30px; color: black; top: 80px; height: 50px; width: 300px; background-color: transparent;">
                ...
                <div v-if="licence.active">
                 <div style="position: relative; top: -45px; left: 400px; color: green" class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked>
                    <label class="form-check-label" for="flexSwitchCheckChecked">Active</label>
                 </div>
                </div>
                <div v-else>
                    <div style="position: relative; top: -45px; left: 350px; color: red" class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                       <label class="form-check-label" for="flexSwitchCheckDefault">Desacti</label>
                    </div>
                </div>
        ...
        <div v-if="see_notif" id="barre-notifs" style="overflow-y: auto">
            ...
            <div  style="position: absolute; top: 100px; left: 20px; color: white">Aucune notification pour l'instant
            </div>
        </div>
    </div>
    </template>
...
export default {
    ...
    data() {
        return {
            memberInfo: {},
            use_pays: [
                {name: 'Sikecodji', enregistrements: 10, profit: false, pourcentage: 5},
                {name: 'Akpakpa', enregistrements: 60, profit: true, pourcentage: 70},
                {name: 'Godomey', enregistrements: 135, profit: true, pourcentage: 90},
                {name: 'Vedoko', enregistrements: 40, profit: false, pourcentage: 37},
                {name: 'Fridjosse', enregistrements: 485, profit: true, pourcentage: 110},
            ],
            versements: [
            ...
            licences: [
                {pays: 'Sikecodji', prix: '5 000 000', active: true},
                {pays: 'Akpakpa', prix: '10 000 000', active: false},
                {pays: 'Vedoko', prix: '100 000 000', active: true},
            ],
            notifications: [
