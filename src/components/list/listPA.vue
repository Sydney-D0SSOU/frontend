<template>
    <div class="" id="page">
        ...
        <div  class="title-box title-text row">Personne Assermentée</div>
      
      <div id="scrollable-content" class="scrollable-content row">
          <div class="box-titre mt-5">
            <div class="title">Liste des Personne Assermentée</div>
      ...
      <div v-if="see_infoCompte" class="info-modal">
        <h3 class="modal-title">Les infos de {{ choosedUser.nom }}</h3>
  ...
  export default {
    ...
    data() {
      return {
        ...
        choosedUser: {},
        routeInscription: '/inscription-persAsser',
        pageSize: 15,
        currentPage: 1,
      };
    },
    ...
    confirmButtonColor:'orange'
      ...
      seeInfoUser(id) {
        ...
        this.choosedUser = this.allComptes.find(user => user.id === id);
      },
      deleteCompte(compte) {
