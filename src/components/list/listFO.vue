<template>
    <div class="" id="page">
        ...
        <div  class="title-box title-text row">Front-Office</div>
      
      <div id="scrollable-content" class="scrollable-content row">
          <div class="box-titre mt-5">
            <div class="title">Liste des Front-Office</div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        choosedUser: {},
        routeInscription: '/inscription-frontOffice',
        pageSize: 15,
        currentPage: 1,
      };
    },
    ...
    created() {
    axios.get('https://emploipourtous.africa/api/front-offices')
      .then(response => {
