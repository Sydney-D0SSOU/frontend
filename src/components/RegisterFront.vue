<template>
    <div id="page" class="background-image">
          <form class= "form" @submit.prevent="submitForm()">
            ...
            <p id="Nature-compte">[Front Office]</p>
            ...
            <input id= "zone" type="text" v-model="formData.zone" placeholder="zone" @input="clearError" required>
...
//import NoAccess from './AccessDenied.vue';
  //import {authAdminRp} from '../auth.js';
  ...
  export default {
    ...
    data() {
      return {
        formData: {
          name: '', status: 'Front office', numero_ip: '', adresse: '', passwd: '', zone: '',
